...
namespace wfVideoMarketProjesi
{
    public partial class frmFilmSatis : Form
    {
        ...
        {
            txtSatisNo.Text = lvSatislar.Items[0].SubItems[0].Text;
            txtTarih.Text = lvSatislar.Items[0].SubItems[1].Text;
            txtFilm.Text = lvSatislar.Items[0].SubItems[2].Text;
            txtMusteri.Text = lvSatislar.Items[0].SubItems[3].Text;
            txtFiyat.Text = lvSatislar.Items[0].SubItems[4].Text;
            txtAdet.Text = lvSatislar.Items[0].SubItems[5].Text;
            txtFilmNo.Text = lvSatislar.Items[0].SubItems[7].Text;
            txtMusteriNo.Text = lvSatislar.Items[0].SubItems[8].Text;
        ...
        private void btnDegistir_Click(object sender, EventArgs e)
        {
            if(txtFilm.Text.Trim() != "" && txtMusteri.Text.Trim() != "")
            {
                ...
                else { MessageBox.Show("Satış güncelleme işlemi gerçekleşmedi!"); }
            }
        ...
        private void btnSil_Click(object sender, EventArgs e)
        {
            ...
            {
                cFilmSatis fs = new cFilmSatis();
                bool Sonuc = fs.SatisSil(Convert.ToInt32(txtSatisNo.Text));
                if (Sonuc)
                {
